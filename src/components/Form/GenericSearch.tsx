        ...
        >
            ...
            <div className="flex gap-2">
                <Button
                    colorScheme='blue'
                    type="button"
                    className="hover:bg-colorBlue-dark rounded-md bg-red px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors duration-300 hover:bg-colorBlue focus:outline-none focus:ring-2 focus:ring-colorBlue focus:ring-offset-2"
                ...
                <Button
                    colorScheme='red'
                    type="button"
                    className="rounded-md bg-red px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors duration-300 hover:bg-colorBlue focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                    onClick={handleClear}
                >
