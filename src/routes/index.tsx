...
import ManajemenInovasiAdminPreview from "@/pages/admin/manajemenInovasi/preview";
    ...
    <Router>
      <AuthProvider>
        <Routes>
          ...
          />
          <Route
            path="/admin/manajemen-inovasi/preview/:id"
            element={
              <PrivateRoute role={ROLE_PERMISSION[ROLE.ADMIN]}>
                <ManajemenInovasiAdminPreview />
              </PrivateRoute>
            }
          />
          <Route
            path="/admin/tambah-inovasi"
            element={
              <PrivateRoute role={ROLE_PERMISSION[ROLE.ADMIN]}>
                <TambahInovasi />
              </PrivateRoute>
          ...
          />
          <Route
            path="/innovator/detail-inovasi/:id"
            element={
              <PrivateRoute role={ROLE_PERMISSION[ROLE.INOVATOR]}>
                <UpdateInovasi />
              </PrivateRoute>
          ...
          />
          <Route
            path="/innovator/wishlist-inovasi"
            element={
              <PrivateRoute role={ROLE_PERMISSION[ROLE.INOVATOR]}>
